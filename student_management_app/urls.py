...
urlpatterns = [
    ...
    path('staff_quiz_home/', StaffViews.QuizListView.as_view(), name="staff_quiz_home"),
    path('staff_quiz_create/', StaffViews.QuizCreateView.as_view(), name="staff_quiz_create"),
    path('staff_quiz_update/<int:pk>/', StaffViews.QuizUpdateView.as_view(), name="staff_quiz_update"),
    path('staff_quiz_delete/<int:pk>/delete/', StaffViews.QuizDeleteView.as_view(), name="staff_quiz_delete"),
    path('staff_quiz_result/<int:pk>/results/', StaffViews.QuizResultsView.as_view(), name="staff_quiz_result"),
    path('staff_quiz_question_add/<int:pk>/question/add/', StaffViews.question_add, name="staff_quiz_question_add"),
    path('quiz/<int:quiz_pk>/question/<int:question_pk>/', StaffViews.question_change, name='question_change'),
    path('quiz/<int:quiz_pk>/question/<int:question_pk>/delete/', StaffViews.QuestionDeleteView.as_view(), name='question_delete'),
    ...
    ### QUIZ APPLICATION
    path('student_quiz_home/', StudentViews.QuizListView.as_view(), name="student_quiz_home"),
    path('student_interest/', StudentViews.StudentInterestsView.as_view(), name="student_interest"),
    path('taken_quiz/', StudentViews.TakenQuizListView.as_view(), name="taken_quiz"),
    path('take_quiz/<str:pk>/', StudentViews.take_quiz, name="take_quiz"),
