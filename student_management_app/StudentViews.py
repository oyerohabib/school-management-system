...
class QuizListView(ListView):
    ...
    template_name = 'student_template/quiz_home_page.html'
...
class StudentInterestsView(UpdateView):
    ...
    template_name = 'student_template/interest_form.html'
    success_url = reverse_lazy('student_quiz_home')
...
class TakenQuizListView(ListView):
    ...
    template_name = 'student_template/taken_quiz_list.html'
        ...
        if form.is_valid():
            with transaction.atomic():
                ...
                if student.get_unanswered_questions(quiz).exists():
                    ...
                    return redirect('student_quiz_home')
    else:
        form = TakeQuizForm(question=question)

    return render(request, 'student_template/take_quiz_form.html', {
        'quiz': quiz,
        'question': question,
        'form': form,
        'progress': progress
